...
- Tapping a medicine notification body switches to Bugün and opens the in-app banner (Al / 3 Dk Ertele / Atla) while that slot is pending. Appointment reminders offer 1 h / 3 h snooze (opening the app); resync keeps snoozes of active appointments (`appt-snooze-<id>-…`) and drops those of completed or deleted ones. Deleting a medicine dismisses its already shown notifications (`dismissDoseNotifications`).
